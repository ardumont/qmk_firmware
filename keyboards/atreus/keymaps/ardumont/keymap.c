...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_RS] = LAYOUT( /* [> RAISE <] */
    ...
    TG(_LW), KC_INS,  KC_LGUI, KC_LSFT, KC_BSPC, ALT_SPC, ALT_SPC, KC_SPC,  KC_TRNS, KC_DOT, KC_0, KC_EQL  ),
  /*
  ...
  [_LW] = LAYOUT( /* [> LOWER <] */
    ...
    KC_NO,   KC_VOLD, KC_LGUI, KC_LSFT, KC_BSPC, ALT_SPC, ALT_SPC, KC_SPC,  TO(_QW), KC_PSCR, KC_SLCK, KC_PAUS )
};
